      ...
      <main className="min-h-screen section-ash pt-[72px] sm:pt-[88px] pb-12 sm:pb-16">
        <div className="max-w-4xl mx-auto px-2 sm:px-4 lg:px-6">
          ...
          <section className="mb-12 sm:mb-16">
            <div className="relative aspect-video sm:aspect-[2/1] rounded-xl overflow-hidden bg-[#f4f4f5]">
          ...
          <section className="mb-12 sm:mb-16" aria-labelledby="process-heading">
            <h2 id="process-heading" className="text-2xl sm:text-3xl font-heading font-normal text-[#111] mb-6 text-center">The Russian Pedicure Process</h2>
          ...
          <section className="text-center py-8 border-t border-[#e4e4e7]">
            <p className="text-[#52525b] font-medium mb-4">Ready to book your pedicure?</p>
