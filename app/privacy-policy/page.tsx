...
export default function PrivacyPolicy() {
  return (
    <main className="max-w-3xl mx-auto py-12 sm:py-16 px-2 sm:px-4 section-ash min-h-screen">
      ...
      <h1 className="text-2xl sm:text-3xl font-heading text-[#111] mb-6">Privacy Policy</h1>
      ...
      <h2 className="text-xl font-heading text-[#111] mt-8 mb-2">What Information We Collect</h2>
      ...
      <h2 className="text-xl font-heading text-[#111] mt-8 mb-2">How We Use Your Information</h2>
      <ul className="list-disc pl-6 mb-4 space-y-1">
