...
export default function CookiesPolicy() {
  return (
    <main className="max-w-3xl mx-auto py-12 sm:py-16 px-2 sm:px-4 section-ash min-h-screen">
      ...
      <h1 className="text-2xl sm:text-3xl font-heading text-[#111] mb-6">Cookies Policy</h1>
      <p className="mb-4">This website uses cookies to make your browsing experience better. Here’s what that means:</p>
      <h2 className="text-xl font-heading text-[#111] mt-8 mb-2">What Are Cookies?</h2>
      ...
      <h2 className="text-xl font-heading text-[#111] mt-8 mb-2">How We Use Cookies</h2>
      ...
      <h2 className="text-xl font-heading text-[#111] mt-8 mb-2">Your Choices</h2>
      <ul className="list-disc pl-6 mb-4 space-y-1">
