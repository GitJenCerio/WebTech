...
export default function AdminLoginPage() {
  ...
  async function handleGoogleSignIn() {
    ...
    try {
      ...
      // Note: signIn with OAuth providers redirects automatically
    ...
    <main className="min-h-screen w-full bg-gray-50 grid place-items-center p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          />
          <h1 className="text-2xl font-acollia">Login</h1>
          <p className="text-gray-600 text-sm mt-2">Enter your credentials to sign in</p>
        </div>
